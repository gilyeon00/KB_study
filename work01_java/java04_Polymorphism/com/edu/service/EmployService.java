...
public class EmployService {
    ...
    public void listAllEmployee (Employee3 [] employee3s) {
    ...
    public Employee3[] findEmployee(Employee3[ ] employees, String dept){
        ...
        int idx = 0;
        for (Employee3 e : employees) {
            if (e instanceof Manager3) {
                if (((Manager3) e).getDept().equals(dept)) temp[idx++] = e;
            }
        }
        return temp;
    }
    ...
    public int getAnnualSalary (Employee3 e) {
        ...
        if (e instanceof Engineer3) {
            annualSalary += ((Engineer3) e).getBonus();
        }
        return annualSalary;
    }
