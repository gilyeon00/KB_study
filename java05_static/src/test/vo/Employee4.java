...
public class Employee4 {
    private String name;
    private MyDate4 birthdate;
    private double salary;
    private int empId;

    public Employee4(int empId, String name, MyDate4 birthdate, double salary) {
        this.empId = empId;
        this.name = name;
    ...
    public MyDate4 getBirthdate() {
        return birthdate;
    }

    public void setBirthdate(MyDate4 birthdate) {
        this.birthdate = birthdate;
    }
